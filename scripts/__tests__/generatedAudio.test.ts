...
describe('generated music asset', () => {
  test('is a 20-second stereo 44.1 kHz PCM WAV', () => {
    ...
    expect(music.readUInt32LE(40)).toBe(44_100 * 20 * 4);
  });
  ...
  test('is quietly mastered without clipping or a boundary click', () => {
    ...
    expect(peak / 32_767).toBeGreaterThanOrEqual(0.219);
    expect(peak / 32_767).toBeLessThanOrEqual(0.221);
